# **Custom CSS Class Naming Convention 🎨**

코드의 일관성과 유지보수성을 높이기 위한 Custom 규칙

### **1. 핵심 원칙**

1. **계층 구조 준수**: 클래스 이름은 항상 `Header__Block__Element_Modifier` 순서를 따름
...
4. 반드시 4개의 요소(header, block, element, modifier)를 모두 사용할 필요 없이 필요에 따라 후순위 요소없이 사용 가능
5. modifier 앞 에는 element-modifier 가 아닌 **element_modifier(언더스코어 1개) 가 적용**되어야함
    ...
    <nav className="navbar">
      ...
      <ul className="navbar__menu">
        ...
        <li className="navbar__menu__item">
          {/* Element: profile_button (역할 기반 이름) */}
